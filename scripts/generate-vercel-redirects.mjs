/**
 * Generates routing rules for Vercel (vercel.json) and Cloudflare Pages (public/_redirects, public/_headers).
 *
 ...
 * - HTTP 410 gone paths are handled by functions/_middleware.js on Cloudflare
 */
...
// Cloudflare Pages: public/_redirects (copied to dist/ by Vite)
const cloudflareRedirectLines = [
  ...
  ...PRERENDER_ROUTES.map((route) => `${route} ${route}/index.html 200`),
  '/* /index.html 200',
];
...
console.log('Wrote public/_redirects and public/_headers for Cloudflare Pages');
