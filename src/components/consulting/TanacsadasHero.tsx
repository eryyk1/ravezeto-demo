...
import './TanacsadasHero.css';

type TanacsadasHeroProps = {
  label: string;
  title: string;
  intro: string;
  image: string;
...
export default function TanacsadasHero({
  label,
  title,
  intro,
  image,
  ...
  return (
    <header ref={ref} className="tanacsadas-hero">
      <div className="tanacsadas-hero__bg" aria-hidden="true" />
      <div className="tanacsadas-hero__grain" aria-hidden="true" />
      <div className="content-wrap tanacsadas-hero__grid">
        <motion.div
          className="tanacsadas-hero__copy"
        ...
        >
          ...
          <p className="tanacsadas-hero__intro">{intro}</p>
        </motion.div>

        <motion.figure
          className="tanacsadas-hero__media"
