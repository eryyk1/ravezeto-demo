...
export function createDefaultContent(): SiteContent {
  return {
    ...
    palyazatok: {
      ...
      deadlineMessage: 'Jelenleg nincs elérhető képzési pályázat',
      aboutText: palyazatokAbout.text,
      aboutLinkLabel: palyazatokAbout.linkLabel,
      aboutLink: palyazatokAbout.link,
      partnersLabel: palyazatokPartners.label,
      partnersLinkLabel: palyazatokPartners.linkLabel,
      partnersLink: palyazatokPartners.link,
      partners: palyazatokPartners.logos.map((logo) => ({ src: logo.src, alt: logo.alt })),
      stepsLabel: palyazatokSteps.label,
      stepsTitle: palyazatokSteps.title,
      steps: [...palyazatokSteps.steps] as [string, string, string],
