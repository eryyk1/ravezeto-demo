...
export default function AdatvedelemBody() {
  return (
    <>
      ...
      <section className="sec">
        <div className="wrap">
          <div className="doc rev">
            <div className="ph">Ide kerül a végleges adatvédelmi szabályzat szövege – élesítés előtt pótlandó.</div>
          </div>
        </div>
      </section>
      ...
      <footer>
        <div className="wrap">
          <div className="cols">
            <div className="flogo"><img src="/assets/images/adatvedelem/img-02.svg" alt="Rávezető Projekt" /><div className="tag">Változásokat vezetünk, együtt!</div></div>
