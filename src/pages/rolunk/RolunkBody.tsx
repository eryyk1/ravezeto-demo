        ...
        <div className="wrap">
          ...
          <div className="team-grid">
            <article className="member rev">
              <h3>Ríz Ádám CMC</h3>
              <a className="li-link" href="https://www.linkedin.com/in/adamriz/" target="_blank" rel="noopener" aria-label="Ríz Ádám LinkedIn profilja"><span className="li-badge" aria-hidden="true">in</span>LinkedIn profil</a>
            ...
            <article className="member rev">
              <h3>Berta Anikó</h3>
              <a className="li-link" href="https://www.linkedin.com/in/anik%C3%B3-berta-426aa03a9/" target="_blank" rel="noopener" aria-label="Berta Anikó LinkedIn profilja"><span className="li-badge" aria-hidden="true">in</span>LinkedIn profil</a>
            ...
            <article className="member rev">
              ...
              <a className="li-link" href="https://www.linkedin.com/in/b%C3%ADr%C3%B3-gabriella-96585538/" target="_blank" rel="noopener" aria-label="Bíró Gabriella LinkedIn profilja"><span className="li-badge" aria-hidden="true">in</span>LinkedIn profil</a>
            ...
            <article className="member rev">
              <h3>Soós Andrea</h3>
              <a className="li-link" href="https://www.linkedin.com/in/andrea-soos-78a203a0/" target="_blank" rel="noopener" aria-label="Soós Andrea LinkedIn profilja"><span className="li-badge" aria-hidden="true">in</span>LinkedIn profil</a>
            ...
            <article className="member rev">
              <h3>Szőke Ádám</h3>
              <a className="li-link" href="https://www.linkedin.com/in/%C3%A1d%C3%A1m-sz%C5%91ke-a628a7a7/" target="_blank" rel="noopener" aria-label="Szőke Ádám LinkedIn profilja"><span className="li-badge" aria-hidden="true">in</span>LinkedIn profil</a>
