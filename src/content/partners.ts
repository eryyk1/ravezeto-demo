/** Partner & reference logos — source: CONTENT_INVENTORY.json logos CPT + ref1–35 (2025/02) */
...
/** Homepage reference grid — 2025/02 thumbnails */
export const referenceClientLogos = [
  ...
  { slug: 'ref4', name: 'MMSZ', logo: wpUpload('2023/01/mmsz-1.jpg') },
  { slug: 'ref5', name: 'Nyugat-Magyarországi Egyetem', logo: wpUpload('2025/02/sze_logo-new.png') },
...
/** logos CPT — institutional partners */
export const partnerLogos: PartnerLogo[] = [
  ...
  { id: 520, name: 'Globomax', slug: 'globomax', logo: wpUpload('2023/01/globomax.jpg') },
  ...
  { id: 534, name: 'Malta', slug: 'malta', logo: wpUpload('2023/01/mmsz-1.jpg') },
  ...
  { id: 546, name: 'Óbudai Egyetem', slug: 'obudaie', logo: wpUpload('2023/01/OE-1.jpg') },
  ...
  { id: 564, name: 'Tudományegyetem', slug: 'te', logo: wpUpload('2023/01/tf2.jpg') },
  { id: 567, name: 'TSZC', slug: 'tszc', logo: wpUpload('2023/01/tszc.jpg') },
  { id: 570, name: 'VEMKH', slug: 'vemkh', logo: wpUpload('2023/01/vemkh-1.jpg') },
];

/** Map client names in case studies to logos where possible */
export const caseStudyLogoMap: Record<string, string> = {
  'Smart Digital Kft.': wpUpload('2025/02/Smart_Digital-new.png'),
  'SALDO Zrt.': wpUpload('2025/02/SALDO-new.png'),
  'Globomax Zrt.': wpUpload('2025/02/globomax-new.png'),
  'Deloitte Üzletviteli és Vezetési Tanácsadó Zrt.': wpUpload('2018/06/ref_01.png'),
  'Széchenyi István Egyetem': wpUpload('2025/02/sze_logo-new.png'),
};
